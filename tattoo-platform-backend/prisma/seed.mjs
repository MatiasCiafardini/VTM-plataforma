  ...
  const categories = [
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          name: 'Conversaciones acumuladas',
          slug: 'conversaciones-acumuladas',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 6,
        ...
        {
          name: 'Nuevos seguidores ganados en el mes',
          slug: 'nuevos-seguidores-mes',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 7,
        ...
        {
          name: 'Seguidores ganados acumulados',
          slug: 'seguidores-ganados-acumulados',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 8,
        ...
        {
          name: 'Variacion de conversaciones vs mes anterior',
          slug: 'crecimiento-conversaciones-mensual',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 11,
        ...
        {
          name: 'Meses consecutivos con crecimiento de conversaciones',
          slug: 'meses-consecutivos-creciendo',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 12,
        ...
        {
          name: 'Meses activos consecutivos en el sistema',
          slug: 'meses-activos-consecutivos',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 13,
        ...
        {
          name: 'Meses consecutivos superando la meta mensual',
          slug: 'meses-consecutivos-sobre-meta',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 14,
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          name: 'Cierres acumulados historicos',
          slug: 'cierres-acumulados',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 6,
        ...
        {
          name: 'Cierres recurrentes acumulados',
          slug: 'cierres-recurrentes-acumulados',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 7,
    ...
    },
    {
      name: 'Logros y Metas',
      slug: 'logros-metas',
      description: 'Indicadores de logros personales y metas de facturacion',
      sortOrder: 4,
      definitions: [
        {
          name: 'Ingresos acumulados historicos (USD)',
          slug: 'ingresos-acumulados',
          valueType: MetricValueType.CURRENCY,
          isRequired: false,
          isMonetary: true,
          sortOrder: 1,
        ...
        {
          name: 'Crecimiento de ingresos vs mes anterior (USD)',
          slug: 'crecimiento-ingresos-mensual',
          valueType: MetricValueType.CURRENCY,
          isRequired: false,
          isMonetary: true,
          sortOrder: 2,
        ...
        {
          name: 'Meta mensual de facturacion alcanzada (1=si, 0=no)',
          slug: 'meta-mensual-alcanzada',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 3,
        ...
        {
          name: 'Mejor mes de carrera registrado (1=si, 0=no)',
          slug: 'mejor-mes-carrera',
          valueType: MetricValueType.INTEGER,
          isRequired: false,
          isMonetary: false,
          sortOrder: 4,
